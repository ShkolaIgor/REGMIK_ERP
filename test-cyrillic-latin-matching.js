...
const testCases = [
  {
    input: '74НС04D',
    expected: '74HS04D',
    description: 'Н→H, С→S (мікросхема, виправлено збіг)'
  },
  {
    input: 'КР580ВМ80А',  
    expected: 'KP580BM80A',
  ...
  },
  {
    input: 'ТМС34010',
    expected: 'TMS34010', 
    description: 'Т→T, М→M, С→S (процесор TI)'
  },
  {
    input: 'АТ89С51',
    expected: 'AT89S51',
    description: 'А→A, Т→T, С→S (мікроконтролер Atmel)'
  },
  {
    input: 'НЕ555Р',
    expected: 'HE555P',
  ...
  },
  {
    input: 'DФ10С',
    expected: 'DF10S',
    description: 'Ф→F, С→S (діод, змішана кирилиця/латиниця)'
  }
];
