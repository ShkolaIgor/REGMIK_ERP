...
import { CalendarDays, Download, FileText, Package, ShoppingCart, TrendingUp, Users, Warehouse, Factory, AlertTriangle, ChartNoAxesCombined } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 mt-1">Детальні звіти з можливістю експорту</p>
                </div>
              </div>
          <div className="flex items-center space-x-4">
