            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-800 bg-clip-text text-transparent">
                      Калькуляції вартості
                    </h1>
                    <p className="text-gray-600 mt-1">Розрахунок вартості та рентабельності продуктів</p>
                  </div>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                  <DialogTrigger asChild>
                    <Button
                      className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:from-purple-700 hover:to-indigo-700 shadow-lg hover:shadow-xl transition-all duration-300"
                    >
        ...
        <main className="w-full px-8 py-3">
              ...
              <CardContent className="p-6 relative overflow-hidden">
                ...
                <div className="flex items-center justify-between relative z-10">
                  <div>
                    ...
                    <p className="text-xs text-purple-600">Активні розрахунки</p>
                  </div>
                ...
                <div className="flex items-center justify-between relative z-10">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-sm text-green-700 font-medium">Середня маржа</p>
                    </div>
                    <p className="text-3xl font-bold text-green-900 mb-1">{averageMargin.toFixed(1)}%</p>
                    <p className="text-xs text-green-600">Рентабельність</p>
                  </div>
                ...
                <div className="flex items-center justify-between relative z-10">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-sm text-blue-700 font-medium">Собівартість</p>
                    </div>
                    <p className="text-3xl font-bold text-blue-900 mb-1">₴{totalValue.toLocaleString()}</p>
                    <p className="text-xs text-blue-600">Загальна вартість</p>
                  </div>
                ...
                <div className="flex items-center justify-between relative z-10">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-sm text-orange-700 font-medium">Продажна ціна</p>
                    </div>
                    <p className="text-3xl font-bold text-orange-900 mb-1">₴{totalSellingPrice.toLocaleString()}</p>
                    <p className="text-xs text-orange-600">Цільова вартість</p>
                  </div>
          ...
          <Card className="p-6 mb-6">
            <SearchFilters
              ...
              filters={[]}
              onFilterChange={() => {}}
              placeholder="Пошук за назвою продукту або SKU..."
            />
          </Card>
