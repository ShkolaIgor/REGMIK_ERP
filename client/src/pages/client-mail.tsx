  ...
  return (
    <div className="p-6">
      ...
      <Dialog open={isEnvelopePrintDialogOpen} onOpenChange={setIsEnvelopePrintDialogOpen}>
        <DialogContent className="w-[1200px] max-w-[95vw] h-[85vh] max-h-none p-4">
          ...
          <div className="flex h-full">
            ...
            <div className="flex-1 flex items-center justify-center bg-gray-50 rounded-lg mr-4 min-w-0">
              <div 
                ...
                style={{
                  ...
                  transform: `scale(${Math.min(
                    800 / envelopeSizes[envelopeSettings.envelopeSize].width,
                    700 / envelopeSizes[envelopeSettings.envelopeSize].height,
                    1.8
                  )})`,
            ...
            <div className="w-80 flex-shrink-0 flex flex-col bg-white rounded-lg p-4 ml-4">
