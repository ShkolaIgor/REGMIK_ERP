          ...
          <div className="bg-white/80 backdrop-blur-sm border-b border-gray-200/50 sticky top-0 z-40">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent">Склад рецептів</h1>
                  <p className="text-gray-500 mt-1">Управління рецептами та технологічними процесами</p>
                </div>
              </div>
                ...
                <CardContent className="p-6 relative overflow-hidden">
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    <div>
                      ...
                      <p className="text-xs text-blue-600">Рецептів з компонентами</p>
                    </div>
                ...
                <CardContent className="p-6 relative overflow-hidden">
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    <div>
                      ...
                      <p className="text-xs text-emerald-600">З продуктами</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <p className="text-sm text-purple-700 font-medium">ЗСередній час</p>
                      </div>
