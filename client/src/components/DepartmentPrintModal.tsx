        ...
        ${departments.map(department => `
          ...
          <div class="department-section">
            <div class="department-header">
              <span class="label">ВИРОБНИЧИЙ ЛИСТ 📋 Замовлення:</span> ${order.orderNumber} 🏭 ${department.departmentName.toUpperCase()} 🏭 <span style="font-size: 8px;>${new Date().toLocaleString('uk-UA')}</span>
            </div>
            <table class="items-table">
              <thead>
                <tr>
