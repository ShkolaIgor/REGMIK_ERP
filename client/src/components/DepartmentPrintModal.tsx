        ...
        ${departments.map(department => `
          ...
          <div class="department-section">
            <div class="department-header">
              <span class="label">ВИРОБНИЧИЙ ЛИСТ 📋</span> ${order.orderNumber}
            </div>
              <div>
                <span class="label">🏭 ${department.departmentName.toUpperCase()}</span>
                <span style="text-align: right; font-size: 6px; !important;">📅 Дата відвантаження: ${deliveryDate}</span>
            </div>
            <table class="items-table">
              <thead>
                <tr>
          ...
          <div style="text-align: right; font-size: 5px; !important;">${new Date().toLocaleString('uk-UA')}</div>
          <div class="header"> </div>
        `).join('')}
