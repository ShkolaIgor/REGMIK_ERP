      ...
      <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-6">
        ...
        {isNovaPoshtaCarrier && (
          <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
            <h3 className="font-medium">Налаштування Нової Пошти</h3>
                    ...
                    {selectedWarehouse ? (
                      ...
                      <div>
                        ...
                        {filteredWarehouses.length > 0 && (
                          <div className="mt-2 max-h-48 overflow-y-auto border rounded-md">
                            {filteredWarehouses.slice(0, 20).map((warehouse: any) => (
                              <div
                                key={warehouse.Ref}
                        ...
                        {warehouseQuery && filteredWarehouses.length === 0 && !warehousesLoading && (
