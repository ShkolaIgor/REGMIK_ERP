...
Функция ПолучитьДанныеКомпании(Организация)
    // КРИТИЧНО: Дані компанії повинні передаватися з КОЖНИМ документом для ідентифікації джерела
    ДанныеКомпании = Новый Структура;
    Если ЗначениеЗаполнено(Организация) Тогда
        ДанныеКомпании.Вставить("НашаКомпанія", Организация.Наименование);
        ДанныеКомпании.Вставить("КомпаніяЄДРПОУ", Организация.КодПоЕДРПОУ); // 8 цифр для юридичних осіб
        ДанныеКомпании.Вставить("КомпаніяІПН", Организация.ИНН); // 10 цифр для ФОП та фізичних осіб
        ДанныеКомпании.Вставить("КомпаніяКод", Организация.Код);
    КонецЕсли;
    Возврат ДанныеКомпании;
КонецФункции

// Функция для отправки данных накладной (ОНОВЛЕНА - тепер передає дані компанії)
Функция ОтправитьДанныеНакладной(Накладная, Действие)
    Попытка
        ...
        // ОБОВ'ЯЗКОВО: Додаємо дані компанії до кожної накладної
...
// Функция для получения данных компании (дублюємо для рахунків)
Функция ПолучитьДанныеКомпании(Организация)
    // КРИТИЧНО: Дані компанії повинні передаватися з КОЖНИМ документом для ідентифікації джерела
    ДанныеКомпании = Новый Структура;
    Если ЗначениеЗаполнено(Организация) Тогда
...
// Функция для отправки данных вихідного рахунку (ОНОВЛЕНА - тепер передає дані компанії)
Функция ОтправитьДанныеВихідногоРахунку(Рахунок, Действие)
    Попытка
        ...
        // ОБОВ'ЯЗКОВО: Додаємо дані компанії до кожного рахунку
