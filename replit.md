...
### July 12, 2025
- ✅ **ВИРІШЕНО ПОМИЛКУ ПЕРЕРАХУВАНЬ 1С** - замінено Перечисление.ТипыНоменклатуры.Товар на фільтрацію за назвою
- ✅ **Створено виправлений код 1C_ВИПРАВЛЕНИЙ_КОД_БЕЗ_ЕНУМІВ.md** - працюючий код без проблемних перерахувань
- ✅ **Фільтрація за назвами номенклатури** - виключення ПОСЛУГ/УСЛУГ/РОБОТ/РАБОТ для товарних накладних
- ✅ **Діагностика структури 1С** - створено інструмент для виявлення полів номенклатури в конкретній базі
- ✅ **Вхідні накладні**: фільтрація тільки товарів через назви позицій
