...
### June 26, 2025
- Виправлено проблему з імпортом BOM через додавання перевірки автентифікації
- Додано візуальні індикатори стану авторизації для кнопки імпорту BOM
- Покращено обробку помилок імпорту з інформативними повідомленнями про необхідність входу
- Застосовано DataTable компонент до списку продуктів у BOM з коректною типізацією
- Виправлено помилки TypeScript в DataTable (колонки: header → label, додано storageKey)
- Очищено код від тимчасового логування та налагоджувального коду
- Зберіг функціональність вибору продукту з картковим відображенням у BOM
