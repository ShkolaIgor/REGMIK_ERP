...
- Виправлено дублювання кнопок пагінації в univerzальному компоненті DataTable
...
- Впроваджено серверну пагінацію для всіх сторінок системи (товари, постачальники)
- Виправлено всі runtime помилки з products.filter/map/length у 10+ компонентах
- Додано змінну effectivePageSize у DataTable для коректної роботи пагінації
- Виправлено дублювання пропсів у DataTableProps інтерфейсі
