...
### July 12, 2025
- ✅ **ФІЛЬТРАЦІЮ НАКЛАДНИХ ПЕРЕНЕСЕНО В 1С** - оптимізація продуктивності шляхом фільтрації на рівні джерела даних
- ✅ **Створено документацію 1C_ТОВАРНІ_ФІЛЬТРИ_КОД.md** - готовий код для 1С з фільтрацією тільки товарних документів
- ✅ **Прибрано фільтрацію з ERP системи** - get1CInvoices та get1COutgoingInvoices тепер очікують готові товарні документи
- ✅ **Покращено продуктивність мережі** - менше трафіку, швидша обробка, точніша фільтрація в джерелі
- ✅ **Оновлено відображення позицій** - підтримка nameFrom1C та erpEquivalent для подвійних назв товарів
