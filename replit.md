...
### July 22, 2025
- ✅ **КРИТИЧНУ ПРОБЛЕМУ ВІДОБРАЖЕННЯ КОЛОНКИ "РАХУНОК" ОСТАТОЧНО ВИРІШЕНО** - виправлено логіку ініціалізації DataTable для автоматичного додавання нових колонок
- ✅ **ПОКРАЩЕНО СИСТЕМУ НАЛАШТУВАНЬ DATATABLE** - нові колонки тепер автоматично додаються до існуючих збережених налаштувань
- ✅ **КОЛОНКА "РАХУНОК" ПОВНІСТЮ ФУНКЦІОНАЛЬНА** - відображає номер рахунку та дату створення замовлення в списку платежів
- ✅ **ВИПРАВЛЕНО BACKEND MAPPING ДЛЯ ПОЛІВ РАХУНКУ** - використовується orders.invoiceNumber та orders.createdAt для правильного відображення
