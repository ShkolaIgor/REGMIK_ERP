...
### July 13, 2025
- ✅ **ВИПРАВЛЕНО ЛІМІТИ БД ПРИ ЗІСТАВЛЕННІ ПОЗИЦІЙ НАКЛАДНИХ** - збільшено ліміт з 5 до 100 записів для повного пошуку товарів та компонентів
- ✅ **ПОКРАЩЕНО АЛГОРИТМ ПОШУКУ ТОВАРІВ** - нормалізований пошук тепер перевіряє 100 записів замість 5 для кращого зіставлення
- ✅ **ПОКРАЩЕНО АЛГОРИТМ ПОШУКУ КОМПОНЕНТІВ** - пошук компонентів при імпорті накладних тепер аналізує 100 записів замість 1
