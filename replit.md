...
- ✅ **Покращено fallback дані** - реалістичні тестові рахунки з металопрофілем та будівельними матеріалами
- ✅ **Додано індикатор демо режиму** - помітний бейдж "демо режим - 1С недоступна" в інтерфейсі користувача
