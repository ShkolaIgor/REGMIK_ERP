...
export const emailSettings = pgTable("email_settings", {
  ...
  bankEmailHost: varchar("bank_email_host", { length: 255 }),
  bankSslEnabled: boolean("bank_ssl_enabled").default(true), // SSL для банківського IMAP
...
export const clients = pgTable("clients", {
  ...
  taxCode: varchar("tax_code", { length: 20 }).unique(), // Для юридичних осіб: ЄДРПОУ (8 цифр), для ФОП та фізосіб: ЄДРПОУ = ІПН (10 цифр), може також включати ІПН до 12 цифр
