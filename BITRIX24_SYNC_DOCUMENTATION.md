...
**Що відбувається всередині webhook функції:**
1. Створюється замовлення в локальній базі ERP
2. Дані рахунку відправляються в зовнішню ERP систему за адресою `https://erp.regmik.ua/bitrix/hs/sync/receive_invoice/`
3. Використовується базова авторизація з логіном `ШкоМ.` та паролем `100`
